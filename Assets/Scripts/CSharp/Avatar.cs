...
public class Avatar : MonoBehaviour 
{
	...
	public GameObject[] GirlHairType;
	public Material[] GirlHairWhite;
	public Material[] GirlHairWhiteSecondary;
	public Material[] GirlHairBlack;
	public Material[] GirlHairBlackSecondary;
	public GameObject Glasses;
	public Material[] EyesColor;
	public GameObject[] Nose;
	public GameObject[] NoseColoured;
	public GameObject eye1;
	public GameObject eye2;
	public GameObject[] Mouth;
	public GameObject[] MouthColoured;
	public GameObject Neck1;
	public GameObject Neck2;
	public GameObject Head;
	public GameObject Cheek1;
	public GameObject Cheek2;
	public Material WhiteHead;
	public Material[] WhiteHeadEyes;
	public Material BlackHead;
	public Material[] BlackHeadEyes;
	public Ray ray;
	...
	public GameObject Eyes1target;
	public GameObject Eyes2target;
	public GameObject NoseTarget;
	public GameObject MouthTarget;
	public GameObject FaceTarget;
	public GameObject Cloth;
	public GameObject ClothColoured;
	public int hairMat;
	public int hairType;
	public int lastHairType;
	...
	void Start () 
	{
		Debug.Log ( PlayerPrefs.GetInt("hairType"));
